                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="${pageContext.request.contextPath }/teacher/addteacher" method="get" id="addteacher">
...
<script>
    ...
    function DeleteByIds(id) {
        location.href="${pageContext.request.contextPath}/teacher/removeteacher?id="+id;
    }
    function EditViewByIds(id) {
        location.href="${pageContext.request.contextPath}/teacher/amendteacher?id="+id;
    }
</script>
