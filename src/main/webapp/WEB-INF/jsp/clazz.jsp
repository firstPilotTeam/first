...
<script type="text/javascript">
    ...
    function operateFormatter(value, row, index) {
        return ['<button id="btn1" type="button" class="btn btn-warning btn-xs" style="margin-left:15px;">删除</button>',
            '<button id="btn2" type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModal" style="margin-left:25px;">修改</button>',
            '<button id="btn3" type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#teachModal" style="margin-left:25px;">班主任</button>'
            ].join('');
